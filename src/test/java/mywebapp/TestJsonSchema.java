...
public class TestJsonSchema {
    ...
    public static void main(String[] args) throws Exception {
        JsonNode mainNode = JsonLoader.fromString(ReadFile.toString("/json/title/template.json"));
        JsonNode instanceNode = JsonLoader.fromString(ReadFile.toString("/json/title/schema/schema.json"));
